...
class PromptDecoder(PeftModel): 
    ...
    def forward(
        ...
        **kwargs,
        ...
        #print("input_ids_shape:", input_ids)
        print("position_ids_1:", position_ids)
        if peft_config.use_prefix_tuning:
        ...
        print("position_ids_model:", position_ids)
        ...
        print("hidden_states_shape_1:", hidden_states.shape)
        if peft_config.use_custom_lm_head:
    ...
    def tree_decoding(
        ...
        print("position_ids_tree:", position_ids.shape)
        print("tree_candidates_embeds:", tree_candidates_embeds.shape)
        outputs = self.base_model(
